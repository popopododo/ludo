...
<div id="sell-reverse" class="container">
<div class="item-image ring-fit">
        <div class="sell-status">R.Auction</div>
        <div class="left"></div>
        <div class="right"></div>
    </div>
    <div class="content">
        ...
        <div class="item-detail">
            ...
            (Gamesoft/Nintendo/Switch/High Quality)
            </div>
        <div class="price">
            <span class="price-now">Now</span> <span class="current-value">$68.00</span>
        </div>
        <div class="time-left">
            <div class="time-box">
        ...
        <div class="description">
            ...
            <div class="description-content">
                <p>I want Ring Fit game</p>
                <p>Want to buy it AS CHEAP AS possible!</p>
            </div>
    ...
    <div class="footer">
        <div class="left-container">
            ...
            <div class="footer-price">
                $&nbsp;<input type="text" class="form-control price-input" placeholder="Below $68.00">
                <!-- <span class="small-price">Above</span>&nbsp;$245.00 -->
            </div>
        </div>
